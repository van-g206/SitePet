                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <div class="form-group">
                                                <input type="email" class="form-style" id="lemail" placeholder="Email">
                                                <span class="error-message"><?php echo $lemail_err; ?></span>
                                                <i class="input-icon uil uil-at"></i>
                                            </div>

                                            <div class="form-group mt-2">
                                                <input type="password" class="form-style" id="lsenha" placeholder="Senha">
                                                <span class="error-message"><?php echo $lsenha_err; ?></span>
                                                <i class="input-icon uil uil-lock-alt"></i>
                                            </div>
                                            <a href="page1.html" class="btn mt-4">Login</a>
                                ...
                                <div class="card-back">
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-style" id="cnome" placeholder="Nome">
                                                <span class="error-message"><?php echo $cnome_err; ?></span>
                                                <i class="input-icon uil uil-user"></i>
                                            </div>
                                            <div class="form-group mt-2">
                                                <input type="tel" class="form-style" id="ctel" placeholder="Número de telefone" pattern="[0-9]*" inputmode="numeric">
                                                <span class="error-message"><?php echo $ctel_err; ?></span>
                                                <i class="input-icon uil uil-phone"></i>
                                            </div>
                                            <div class="form-group mt-2">
                                                <input type="email" class="form-style" id="cemail" placeholder="Email">
                                                <span class="error-message"><?php echo $cemail_err; ?></span>
                                                <i class="input-icon uil uil-at"></i>
                                            </div>
                                            <div class="form-group mt-2">
                                                <input type="password" class="form-style" id="csenha" placeholder="Senha">
